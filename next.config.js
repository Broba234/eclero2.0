        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' blob: data: https://*.supabase.co wss://*.supabase.co wss://*.livekit.cloud https://*.livekit.cloud https://unpkg.com https://api.stripe.com",
              "worker-src 'self' blob:",
              "frame-src 'self' blob: https://*.supabase.co https://js.stripe.com",
